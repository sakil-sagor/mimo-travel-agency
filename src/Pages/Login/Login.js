...
const Login = () => {
    const { errorLogin, getEmail, setUser, setErrorLogin, setIsLoading, getPassword, googleLogin, manualLogin } = useAuth();
        ...
        <div className="login-page bg-pink-200">
            ...
            <div className="container m-auto py-32 px-4 grid grid-cols-12 gap-4 items-center full-width-all  py-24">
                ...
                <div className="col-span-12 sm:col-span-8 md:col-span-6 ">
                    <h1 className="mb-8 text-5xl font-bold text-pink-500">Log In</h1>
                    <div>
                    ...
                    <div className="w-full">
                        <form onSubmit={handelLogin}>
                            ...
                            <br />
                            <input type="text" type="submit" className="cursor-pointer text-base block font-bold text-white px-4 py-2 uppercase bg-pink-500 hover:bg-pink-700
radiou rounded-sm " value="login" />
                    ...
                    <div className="flex mt-8 login-btn">
                        <button onClick={handelGoogleLogin} className="mr-2 text-base block font-bold text-white px-4 py-2 bg-pink-500 hover:bg-pink-700
