...
const Register = () => {
    const { getEmail, setUser, getDisName, errorReg, setErrorReg, setIsLoading, getPassword, updateProfileName, googleLogin, ManualRegister } = useAuth();
        ...
        <div className="bg-pink-200">
            ...
            <div className="container m-auto py-32 grid grid-cols-12 gap-4 items-center	full-width-all px-4">
                ...
                <div className="col-span-12 sm:col-span-8 md:col-span-6">
                    <h1 className="mb-8 text-4xl font-bold text-pink-500">Register Now</h1>
                    {/* error message  */}
                    <div>
                    ...
                    <div className="w-full">
                        ...
                        <form onSubmit={handelRegister} >
                            ...
                            <br />
                            <input type="text" type="submit" className="cursor-pointer	 text-base block font-bold text-white px-4 py-2 uppercase bg-pink-500 hover:bg-pink-700 radiou rounded-sm " value="Sign Up" />
                        </form>
                    </div>
                    <div className="mt-8">
                    ...
                    <div className="flex mt-8">
                        <button onClick={handelGoogleLogin} className="mr-2 text-base block font-bold text-white px-4 py-2  bg-pink-500 hover:bg-pink-700 radiou rounded-sm ">Google Login</button>
                    </div>
                </div>
